...
namespace BookStoreApp.API.Migrations
{
    ...
    [Migration("20250512210034_SeededDefaultUserandRoles")]
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.ApiUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c6aeae62-4d6b-4721-a9b4-3a63e4546a76",
                            AccessFailedCount = 0,
                        ...
                        new
                        {
                            Id = "70e930a4-49a8-43a0-b01b-2ed82eae5fb8",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "k1111111-l222-m333-n444-o55555555555",
                            Email = "user@bookstoreapp.com",
                            EmailConfirmed = false,
                            FirstName = "System",
                            LastName = "User",
                            LockoutEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "k1111111-l222-m333-n444-o55555555555",
                            Email = "normaluser@bookstore.com",
                            EmailConfirmed = false,
                            FirstName = "System",
                            LastName = "NormalUser",
                            LockoutEnabled = false,
                            NormalizedEmail = "NORMALUSER@BOOKSTORE.COM",
                            NormalizedUserName = "NORMALUSER@BOOKSTORE.COM",
                            PasswordHash = "1f3c53ae14626035383b39c207564d32d083e8fd",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "p1111111-q222-r333-s444-t55555555555",
                            TwoFactorEnabled = false,
                            UserName = "normaluser@bookstore.com"
                        });
                });
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Author", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Authors__3214EC072BD00103");
            ...
            modelBuilder.Entity("BookStoreApp.API.Data.Book", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Books__3214EC0739DB17D5");

                    b.HasIndex("AuthorId");

                    b.HasIndex(new[] { "Isbn" }, "UQ__Books__447D36EA36CC5CA7")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9cd7faf3-86f2-4983-b11e-045d4a623581",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "865474e2-bddf-4893-9581-b0f31104c01a",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "70e930a4-49a8-43a0-b01b-2ed82eae5fb8",
                            RoleId = "9cd7faf3-86f2-4983-b11e-045d4a623581"
                        },
                        new
                        {
                            UserId = "c6aeae62-4d6b-4721-a9b4-3a63e4546a76",
                            RoleId = "865474e2-bddf-4893-9581-b0f31104c01a"
                        },
                        new
                        {
